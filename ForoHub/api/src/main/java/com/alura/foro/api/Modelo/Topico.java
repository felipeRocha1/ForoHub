...
import com.alura.foro.api.Dto.Topicos.ActualizarTopicos;
import com.alura.foro.api.Dto.Topicos.RegistroTopicos;
...
public class Topico {
    ...
    public Topico(RegistroTopicos datos, Usuario autor, Curso curso) {
    ...
    public void actualizarDatos(ActualizarTopicos datosActualizar, Usuario autor, Curso curso) {
