...
import com.alura.foro.api.Dto.usuario.ActualizarUsuario;
import com.alura.foro.api.Dto.usuario.RegistroUsuario;
...
public class Usuario implements UserDetails {
    ...
    public Usuario(RegistroUsuario datos) {
    ...
    public void actualizarDatos(ActualizarUsuario datosActualizar) {
